...
export default async (req, res) => {
    ...
    try {
        ...
        // Find cart base on user id, populate it
        ...
        // Get email for payment data, see if email linked with exisitng Stripe customer
        ...
        // If not existing customer, create new customer based on email
        let newCustomer
